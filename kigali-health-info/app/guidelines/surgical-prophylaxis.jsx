...
export default function SurgicalProphylaxisScreen() {
  const { toggleFavorite, isFavorite } = useFavorites();
  const pageInfo = { route: "/guidelines/surgical-prophylaxis", name: "Surgical Prohylaxis" };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.title}>Surgical Prophylaxis</Text>
