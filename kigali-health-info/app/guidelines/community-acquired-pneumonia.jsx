...
export default function CommunityAcquiredPneumoniaScreen() {
  ...
  const pageInfo = { route: "/guidelines/community-acquired-pneumonia", name: "Community Acquired Pneumonia" };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.title}>Community Acquired Pneumonia</Text>
